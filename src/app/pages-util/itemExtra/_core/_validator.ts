import { T_submit, T_fetched_itemExtra } from './_type'
...
export const is_fetched_data_valid = (data: unknown): data is T_fetched_itemExtra[] => {
...
export const is_filled_data_valid_edit = (data: unknown): data is T_fetched_itemExtra => {
