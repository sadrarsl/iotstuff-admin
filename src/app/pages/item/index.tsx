...
// import Search from "src/pages-util/item/components/Search";
...
import {
  T_fetched_item,
  T_item_search,
} from "../../pages-util/item/_core/_type";
import {
  delete_item,
  fetch_all_item,
  post_item,
  update_item,
} from "../../pages-util/item/_core/_crud";
import {
  filled_data_validation,
  is_fetched_data_valid,
  is_filled_data_valid,
  is_filled_data_valid_edit,
} from "../../pages-util/item/_core/_validator";
import { columns, options_core } from "../../pages-util/item/_core/_config";
...
import Search from "../../pages-util/item/components/Search";
import Table from "../../modules/table/Table";
import Modal from "../../modules/modal/Modal";
import Fields from "../../pages-util/item/components/Fields";
...
export default (): ReactNode => {
  ...
  const [data, setData] = useState<T_fetched_item[]>([]);
  // Declared To Hold Table's Searched Data
  const [searchData, setSearchData] = useState<T_item_search>({});
  ...
  const fetch_data = (searchParams?: T_item_search) => {
    setIsLoading(true);
    if (isRead) {
      fetch_all_item(TOKEN, {
        ...searchParams,
  ...
  */
  ...
  const searchs = {
    itemCategoryId: (value: any) => handleSearchOption("itemCategoryId", value),
  };

  // Table Search's Fields Changes Handler
  const changes = {
    itemCategoryId: (value: any) => handleSearchData("itemCategoryId", value),
            ...
            <Table
              ...
              tableProps={{
                pagination: {
                  ...
                  locale: { items_per_page: instanceName },
