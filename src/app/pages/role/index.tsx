...
// import Search from "src/pages-util/role/components/Search";
...
import {
  T_fetched_role,
  T_role_search,
} from "../../pages-util/role/_core/_type";
import {
  delete_role,
  fetch_all_role,
  post_role,
  update_role,
} from "../../pages-util/role/_core/_crud";
import {
  filled_data_validation,
  is_fetched_data_valid,
  is_filled_data_valid,
  is_filled_data_valid_edit,
} from "../../pages-util/role/_core/_validator";
import { columns, options_core } from "../../pages-util/role/_core/_config";
...
import Search from "../../pages-util/role/components/Search";
import Table from "../../modules/table/Table";
import Modal from "../../modules/modal/Modal";
import Fields from "../../pages-util/role/components/Fields";
...
export default (): ReactNode => {
  ...
  const [data, setData] = useState<T_fetched_role[]>([]);
  // Declared To Hold Table's Searched Data
  const [searchData, setSearchData] = useState<T_role_search>({});
  ...
  const fetch_data = (searchParams?: T_role_search) => {
    setIsLoading(true);
    if (isRead) {
      fetch_all_role(TOKEN, {
        ...searchParams,
  ...
  */
  ...
  const searchs = {
    roleId: (value: any) => handleSearchOption("roleId", value),
  ...
  const changes = {
    ...
    role: (value: any) => handleSearchData("role", value),
    roleId: (value: any) => handleSearchData("roleId", value),
            ...
            <Table
              ...
              tableProps={{
                pagination: {
                  ...
                  locale: { roles_per_page: instanceName },
                  roleRender: (page: any, type: any, originalElement: any) => {
                    switch (type) {
                      case "prev":
